...
<head>
    ...
    <title>Aggiorna Lavoratore</title>
...
<div class="container">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <label for="nomeProcesso" class="form-label"> Nome del processo di appartenenza:</label>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <label for="username" type="hidden" class="form-label"> </label>
                <form:input  type="hidden" path="username" class="form-control" id="username" required="true"/>
            </div>
            <div class="col-md-6">
                <label for="password" type="hidden" class="form-label"></label>
                <form:input type="hidden" path="password" class="form-control" id="password" required="true"/>
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="d-grid gap-2 col-6 mx-auto" >
            <button class="btn btn-primary" type="submit" id="bottone">Aggiorna lavoratore</button>
        </div>
        </form:form>
    </div>
        <center>
