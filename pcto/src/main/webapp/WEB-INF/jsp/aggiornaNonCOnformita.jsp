...
<div>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <form:input type="date" path="dataInizio" class="form-control" id="dataInizio" readonly="true"/>
            </div>
        </div>
        <div class="row g-3">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <form:input path="nomeSegnalatore" class="form-control" id="nomeSegnalatore" readonly="true"/>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <form:textarea path="descrizione" class="form-control" id="descrizione" placeholder="Lascia una descrizione qui" style="height: 100px"/>
                            <label for="descrizione">Descrizione</label>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="codiceProdotto" class="form-label"> Codice del prodotto:</label>
                    <form:input path="codiceProdotto" class="form-control" id="codiceProdotto" readonly="true"/>
                    <div id="showList">
                        <ul class="list-group">
                        </ul>
                    </div>
            ...
            <div class="row g-3">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label for="tipologia" class="form-label">Tipologia della non conformita:</label>
                ...
                <div class="d-grid gap-2 col-6 mx-auto" >
                    <button class="btn btn-primary" type="submit" id="bottone">Aggiorna non conformità</button>
                </div>
            </div>
            </form:form>
        </div>
    ...
    <center>
        <a href="<c:url value="/listaNonConfAperte"/> " class="btn btn-primary">Torna Indietro</a>
    </center>
</body>
</html>